...
class CodeLimitController extends Controller
{
    /**
        ...
        switch ($op) {
            ...
            case "updated":
                ...
                if($id){
                    ...
                    $sqlstr = 'update `exinco_code_limit` set '.$keystr.' where (`id`='.$id.')';
                    //dd($sqlstr);
                    ...
                    $sqlstr = 'insert into `exinco_code_limit` ('.$keystr.') values ('.$valuestr.')';
                    $result = DB::insert($sqlstr);
                }
